...
public class FiltersConfig {
    ...
    public double maxLatencyMillis = 100; // Reject if data is too old //TODO need to be match to the history size in
                                          // the poseestimation, but its a good filter to add
    ...
    /**
     * Degrees: <= softYawFullTrustDeg → yaw trust ≈ 1, then smooth drop to 0 at
     * hard gate.
     */
